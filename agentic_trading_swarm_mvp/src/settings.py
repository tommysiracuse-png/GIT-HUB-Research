...
DEFAULT_SETTINGS = {
    ...
    "scanner": {
        ...
        "enable_public_market_adapter_scan": True,
    ...
    "strategy_lab": {
        ...
        "promoted_signal_runtime_max_observations": 500,
        "max_candidates_per_loop": 30,
        "max_candidates_per_experiment": 10,
        "runtime_review_reserved_slots": 15,
    ...
    "autonomous_cost_guard": {
        ...
        "ledger_path": "runs/autonomous_paid_attempts.sqlite",
    },
    "codex_worker_pool": {
        "enabled": False,
    ...
    "contextual_failure_filters": {
        ...
        "opportunity_sample_limit": 5_000,
