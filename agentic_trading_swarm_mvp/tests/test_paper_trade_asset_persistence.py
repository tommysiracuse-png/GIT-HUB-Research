...
class PaperTradeAssetPersistenceTests(unittest.TestCase):
    def test_runtime_pipeline_integration_category(self) -> None:
        payload = {
            "action": "propose_code_change",
            "title": "Paper trade asset persistence",
            "code_change": {
            ...
            "proposed_change": "Persist base_asset and quote_asset on open and close records and preserve serialization across paper trade persistence.",
        }
