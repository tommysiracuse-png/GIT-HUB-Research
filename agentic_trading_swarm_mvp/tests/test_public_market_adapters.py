...
class PublicAdapterParserTests(unittest.TestCase):
    ...
    def test_cbb_tbill_parser_normalizes_issue_number_price_and_rate(self) -> None:
        ...
        self.assertEqual(4.91, row["average_yield_pct"])
        self.assertEqual(101.0, row["oversubscription_pct"])
        self.assertEqual(2.01, row["coverage_ratio"])
        self.assertEqual(91, row["term_days"])
        self.assertEqual("2025-12-15T00:00:00+00:00", row["auction_at"])
    ...
    def test_b3_adapter_attaches_companion_quotes_to_bdr_etf_and_cbio_surfaces(self) -> None:
        hub = {
            ...
            "http_status": 200,
            "text": """
            <section><a href="/en_us/b3/esg/otc-market.htm">Decarbonization credits CBIO</a></section>
            <section><a href="/pt_br/fi-infra-listados/">FI-Infra</a><a href="/en_us/fiagro.htm">FIAGRO</a><a href="/pt_br/fidc.htm">FIDC</a></section>
            <section>
              <a href="/en_us/stock-etf.htm">Stock Exchange Traded Fund - Stock ETF</a>
              <a href="/pt_br/bdr-etf.htm">BDRs ETFs</a>
              <a href="/en_us/unsponsored-bdr.htm">Unsponsored Brazilian Depositary Receipts - BDRs</a>
            </section>
            """,
            "received_at": "2026-08-04T12:00:00+00:00",
            "latency_ms": 4.0,
        ...
        companion = {
            ...
            "status": "reachable",
            "http_status": 200,
            "text": "<html><body><p>The current price of EWZ is 29.84 USD.</p></body></html>",
        ...
        self.assertEqual("verified_proxy", bdr["quality_status"])
        self.assertEqual("AMEX:EWZ", bdr["proxy_symbol"])
    ...
    def test_b3_tradingview_quote_parser_extracts_public_etf_price(self) -> None:
        quote = parse_tradingview_b3_etf_quote(
            "<html><body><p>The current price of EWZ is 30.12 USD.</p></body></html>",
            received_at="2026-08-04T12:00:00+00:00",
        )

        self.assertEqual(30.12, quote["last"])
...
"""
    ...
    def test_aofm_parsers_normalize_scheduled_tender_and_result_workbook(self) -> None:
        ...
        self.assertEqual(4.321, results[0]["last"])
        self.assertEqual(4.321, results[0]["weighted_average_yield_pct"])
        self.assertEqual(4.321, results[0]["average_yield_pct"])
        self.assertEqual(2.15, results[0]["coverage_ratio"])
        self.assertEqual(7531, results[0]["term_days"])
        self.assertEqual("official_auction_result", results[0]["quality_status"])
        self.assertEqual("official_auction_result_not_executable_quote", results[0]["candidate_reject_reason"])
